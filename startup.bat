...
REM Hasta Radiologi PACS Server Startup Script (Windows)
REM Docker container name: hasta-pacs
REM Provides persistent storage and proper configuration
...
echo.
echo 🏥 Hasta Radiologi PACS Server Startup
echo ========================================
...
REM Create plugins directory but don't mount it to avoid plugin conflicts
...
REM Start Orthanc container with persistent storage
